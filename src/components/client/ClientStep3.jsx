...
const ClientStep3 = ({ onWhatsAppClick, onReset }) => {
    return (
        <main className="flex-1 flex flex-col items-center justify-center px-8 text-center animate-[fadeIn_0.5s_ease-out] pb-20">
            ...
            {/* Texto explicativo mejorado: más claro y con énfasis en la acción */}
            <p className="text-gray-300 text-sm mb-12 leading-relaxed max-w-[280px] mx-auto">
                Para finalizar el proceso, es <span className="text-[#25D366] font-semibold">obligatorio</span> enviar el mensaje de confirmación al barbero.
            </p>

            {/* Botón Opción 1: Verde Teal (#128C7E), sin sombra neón, más sobrio */}
            <button
                className="w-full max-w-sm bg-[#128C7E] hover:bg-[#075E54] text-white font-bold text-sm py-4 rounded-md flex items-center justify-center gap-3 uppercase transition-all shadow-lg mb-4 tracking-wider border border-white/10"
